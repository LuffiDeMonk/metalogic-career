            ...
            <section className='h-[105vh] bg-gradient-to-b from-[#b4b2b2] via-[#b4b2b2]/70 to-[#f6f8ff]'>
                <div className="overflow-hidden w-full h-full relative">
                    ...
                    <div className="absolute w-full h-full inset-0 bg-transparent z-10">
                        <MotionDiv variants={MainAnimation} initial='initial' whileInView='whileInView' viewport={{ once: true }} className='w-full h-full flex items-center justify-center flex-col'>
